                    ...
                    <div className="col-lg-4 offset-lg-2 col-md-6 offset-md-3">
                        ...
                        <div className="mt-3 mt-md-5">
                            ...
                            <form className="pt-4">
                                ...
                                <input type="password" name="passwrd" id="pwd" className="loginInput border-bottom border-primary"onChange={onChangePassHandler}/> </div>
                                
                                <input type="button" value="Sign up" className=" btn btn-primary btn-block mb-3" onClick = {signInWithEmailAndPasswordHandler}/> 
                                ...
                                <div className="register mt-5">
                                    <p>Already a member ? <Link to="login" className="text-blue-500 hover:text-blue-600">
                                        Log in here
                                    </Link>{" "}</p>
                                </div>
                            </form>
